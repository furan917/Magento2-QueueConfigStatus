...
namespace Furan\QueueConfigStatus\Console\Command\App;

use Furan\QueueConfigStatus\Model\QueueConfig\ChangeDetector;
...
/**
 * Command for checking if Consumer propagation is up to date
 */
class QueueConfigStatusCommand extends Command
{
     ...
     */
    public const EXIT_CODE_CONSUMER_UPDATE_REQUIRED = 2;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        if ($this->changeDetector->hasChanges()) {
            ...
            return self::EXIT_CODE_CONSUMER_UPDATE_REQUIRED;
        }
